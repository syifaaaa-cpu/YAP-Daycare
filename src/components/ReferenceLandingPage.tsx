...
const programs: Card[] = [
  { title: 'Baby Care', text: 'Pendampingan penuh kasih, stimulasi sensori, dan rutinitas aman.', icon: Baby, image: '/images/asih-fish-adventure.jpg' },
  { title: 'Toddler', text: 'Eksplorasi aktif, bahasa awal, motorik, dan sosial.', icon: Heart, image: '/images/asih-outdoor-ball.jpg' },
  { title: 'Pra-TK', text: 'Kemandirian, bahasa, bermain terarah, dan kesiapan sekolah.', icon: BookOpen, image: '/images/asih-fish-adventure.jpg' },
  { title: 'Daycare Harian', text: 'Program fleksibel setengah hari atau penuh hari.', icon: Clock3, image: '/images/asih-outdoor-ball.jpg' },
];
  ...
  return <main className="reference-page">
    <section className="ref-hero" id="profil">
      <div className="ref-wrap ref-hero-inner">
        ...
        <div className="ref-hero-image"><img src="/images/asih-outdoor-ball.jpg" alt="Anak-anak bermain bersama" /><div className="ref-image-note"><Sparkles /> Bermain, belajar, dan bertumbuh</div></div>
      </div>
    </section>
    ...
    <section className="ref-wrap ref-section"><Title>Program Unggulan Daycare Asih Putera</Title><div className="ref-grid three">
      <InfoCard card={{ title: 'Ragam Main Bermakna', text: 'Belajar sambil bermain yang menyenangkan dan terarah.', icon: Sparkles, image: '/images/asih-outdoor-ball.jpg' }} />
      <InfoCard card={{ title: 'Tahfidz & Adab Harian', text: 'Pembiasaan doa, adab, dan nilai Islam sejak dini.', icon: BookOpen, image: '/images/asih-fish-adventure.jpg' }} />
      <InfoCard card={{ title: 'Sensori-Motorik & Kemandirian', text: 'Mengasah gerak, otot halus, dan rasa percaya diri.', icon: Sprout, image: '/images/asih-outdoor-ball.jpg' }} />
    </div></section>
    ...
    <section className="ref-wrap ref-bottom-grid"><div><Title>Apa Kata Orang Tua?</Title><div className="ref-testimonials"><blockquote>“Anak saya jadi lebih mandiri dan ceria. Pengasuhnya hangat, lingkungannya bersih dan aman.”<footer>Ibu Rina Septiani<br /><Star /><Star /><Star /><Star /><Star /></footer></blockquote><blockquote>“Programnya lengkap, nilai Islam ditanamkan sejak kecil. Kami merasa tenang menitipkan anak.”<footer>Bapak Ilman Pratama<br /><Star /><Star /><Star /><Star /><Star /></footer></blockquote></div></div><div><Title>Berita & Agenda</Title><div className="ref-news"><img src="/images/asih-fish-adventure.jpg" alt="Kegiatan daycare" /><img src="/images/asih-outdoor-ball.jpg" alt="Kegiatan outdoor" /></div></div></section>
